...
openssl req -new -key wildcard.key -out wildcard.csr -subj "/CN=*.com"

# Generate a certificate for the wildcard domain signed by the CA
openssl x509 -req -in wildcard.csr -CA ca.crt -CAkey ca.key -CAcreateserial -out wildcard.crt -days 365 -sha256
